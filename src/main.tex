...
% Om arbetet är långt har det en innehållsförteckning, annars kan den utelämnas
    ...
    Ett vattenkraft fungerar genom att man dammar av en bit av ett vattendrag t.ex. en älv eller
    Den bit som är avdammad kallas för vattenmagasin. Dammen kan som byggds lagrar vatten och därmed energi.
    När man vill utvinna elektricitet öppnas luckor i dammen som tillåter vatten att falla ner i tunnlar till en turbin.
    Vattnet snurrar turbinen som skapar rörelse energi. Rörelse energin driver en genetator som skapar elektriciteten.
    /textcitate{vattenkraft}
